...
export function IssueCard({ issue }: { issue: AuditIssue }) {
  return (
    <article className="rounded-2xl border border-white/10 bg-white/[0.035] p-5 transition hover:border-yellow-300/30 hover:bg-white/[0.055]">
      ...
      {issue.evidence ? (
        <details className="mt-3 rounded-2xl border border-white/10 bg-black/20 p-4 text-xs text-zinc-400">
