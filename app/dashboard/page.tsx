  ...
  return (
    <main className="mx-auto min-h-[70vh] max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-4">
        {reports.length === 0 ? <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 text-zinc-400">No reports yet. Run your first website audit from the homepage.</div> : null}
        {reports.map((report) => (
